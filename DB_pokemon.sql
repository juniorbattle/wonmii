...
CREATE TABLE IF NOT EXISTS `pokemons` (
  ...
  `hp` int(100) DEFAULT NULL,
  `attack` int(100) DEFAULT NULL,
  `defense` int(100) DEFAULT NULL,
  `sp_atk` int(100) DEFAULT NULL,
  `sp_def` int(100) DEFAULT NULL,
...
INSERT INTO `pokemons` (`id`, `name`, `type1`, `type2`, `total`, `hp`, `attack`, `defense`, `sp_atk`, `sp_def`, `speed`, `generation`, `legendary`) VALUES
...
(101, 'Electrode', 'Electric', 'test', 480, 60, 50, 70, 80, 80, 140, 1, 'False'),
